...
<style>
    ...
    .carousel-inner {
        position: relative;
        overflow: hidden;
        /* Untuk menghindari elemen meluas keluar slider */
    }

    .carousel img.slider-img {
        width: 100%;
        /* Gambar selalu menyesuaikan lebar kontainer */
        height: auto;
        /* Menjaga aspek rasio gambar */
        max-height: 90vh;
        /* Membatasi tinggi maksimum slider agar tidak terlalu besar */
    }
    ...
    <div id="home-slider2" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="images/image-slider.jpeg" alt="slider1" class="slider-img" />
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 col-sm-8 col-xs-12 text-right no-padding">
                                ...
                                <h3 data-animation="animated fadeInDown"><span>di Website SMP Muhammadiyah 4 Medan</span></h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <img src="images/guru.jpeg" alt="slider3" class="slider-img" />
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row">
                        </div>
            ...
            <div class="item">
                <img src="images/slider3.png" alt="slider2" class="slider-img" />
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-4">
                <a href="{{ route('form-pendaftaran') }}"> Daftar Sekarang </a>
            </div>
        </div>
    </div>
</div>
